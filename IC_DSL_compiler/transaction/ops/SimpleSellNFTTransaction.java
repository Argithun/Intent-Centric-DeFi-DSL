...
public class SimpleSellNFTTransaction {

    public static boolean genSimpleSellNFTTransaction(Node.Statement statement, String privateKey) throws Exception {
        // https://docs.opensea.io/reference/post_listing
        Node.SimpleSellNFTStatement sellNFTStatement = (Node.SimpleSellNFTStatement) statement;
        ...
        String preferToken = Token.getContractAddressByToken(sellNFTStatement.getPreferPrice().getAsset());
        BigInteger preferAmount = Calculator.calBinaryExp(sellNFTStatement.getPreferPrice().getBinaryExpression()).
                multiply(new BigDecimal(Token.getTokenDecimals(preferToken))).toBigInteger();
